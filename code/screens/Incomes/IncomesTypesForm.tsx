...
import { addIncomes, addIncomesType, expensesTypesList, incomesTypesList } from '../../Services/ApiService';
import { RadioButton } from 'react-native-paper';
import { Switch } from "@rneui/themed";
import { globalStyle } from '../../utils/GlobalStyles';


export default function IncomesTypesForm({ navigation }: RootTabScreenProps<'Incomes'>) {
  ...
  return (
     <View style={styles.container}>
      ...
      <Button
            withIcon={false} 
            onPress={async ()=>{
              let resp = await addIncomesType(formData);
              if (resp.status) {
                setFormData({});
